...
const Logo = ({ className }: LogoProps) => (
  ...
  >
    <g id="logomark">
      ...
      />
      <path
        d="M50.1173 9.31033L39.9237 17.9705C39.4295 18.3904 38.8036 18.6207 38.157 18.6207H29.9362L40.1048 9.96252C40.5993 9.5414 41.2261 9.31033 41.8738 9.31033H50.1173Z"
        fill="var(--color)"
      />
      <path
