...
import { heroData, logos } from "@/data/Hero.data"
import TrustedBrands from "./TrustedBrands"

const Hero = () => {
  return (
    <section className="relative isolate flex w-full flex-col items-center overflow-hidden">
      <div className="relative flex flex-col w-full items-center overflow-hidden text-center pt-16 md:py-2 pb-12 md:pb-20">
